...
//SG20110909: für Ausgabe in *.rfp
     ...
     //LCRT   = max(min(CSRT-1.E-4,CSRT-min(CSRTN,CSRT)),0.)/DELT;//rate [g(C) m-2 d-1]
	  ...
	  LCRT   = LCRT*self->DAYL/24.0;//Hong 20191113
      ...
      */
      ...
      RSLNB  =RSLNB*self->DAYL/24.0;//Hong 20191113  
      ///*
...
//End of Hong	
   ...
   //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	  ...
	  RNDEMP = RNDEMP*self->DAYL/24.0;//Hong 20191113  
...
//-----------------------------------------------------------------------------------------
	  ...
	  RRMUL=RRMUL*self->DAYL/24.0;//Hong 20191113  
	  ...
	  RDCDTP=RDCDTP*self->DAYL/24.0;//Hong 20191113  
	 ...
	 LWLVM =LWLVM*self->DAYL/24.0;//Hong 20191113  
...
//-------------------------------------------------------------------------------------
	  ...
	  RRD=RRD*self->DAYL/24.0;//Hong 20191113
...
//-------------------------------------------------------------------------------------
	  ...
	  RNSUPP=RNSUPP*self->DAYL/24.0;//Hong 20191113
              ...
              double *DCDC,double *DCD,double *FLWC)
{
 ...
 //%---total demand for C at the time step considered
	  ...
	  *DCD=*DCD*12.0/24.0;//Hong 20191113
