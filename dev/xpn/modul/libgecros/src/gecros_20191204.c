...
//-----------------------------------------------------------------------------------------
	  ...
	  printf("xpn->pTi->pSimTime->fTimeDay-2: %f\n",xpn->pTi->pSimTime->fTimeDay);
	  printf("NUPT = %f\n",NUPT);
	  printf("pPltN->fActNUpt = %f\n",pPltN->fActNUpt);
	  printf("NDEM = %f\n",NDEM);
	  printf("NFIXR = %f\n",NFIXR);
	  if (NUPT >0)
	  {
...
//    LWLV   = min(WLV-1.E-5, LWLVM+REANOR(ESD-DS,LWLVM)*0.03*WLV);
	  ...
	  printf("xpn->pTi->pSimTime->fTimeDay-4: %f\n",xpn->pTi->pSimTime->fTimeDay);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		printf("xpn->pTi->pSimTime->fTimeDay-1: %f\n",xpn->pTi->pSimTime->fTimeDay);
		printf("NDEM= %f\n", NDEM);
//End of Hong	
...
/*	
	...
	//Test of Hong
	printf("xpn->pTi->pSimTime->fTimeDay-3: %f\n",xpn->pTi->pSimTime->fTimeDay);
	printf("fnsup =%f\n",fnsup);
	printf("fndem =%f\n",fndem);
	printf("fnup =%f\n",fnup);
