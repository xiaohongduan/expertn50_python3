...
struct_fixedparameter century_n_getFixedParameters()
{
	...
	fixed.dec3[0]=6.0;
	fixed.dec3[1]=7.3;
	//fixed.p1co2a[0]=0.6;// Hong
	//fixed.p1co2a[1]=0.17; // Hong
	fixed.p1co2a[0]=0.006;// Hong
	fixed.p1co2a[1]=0.0017; // Hong
	fixed.pligst[0]=3.0;
	fixed.pligst[1]=3.0;
	fixed.spl[0]=0.85;
	fixed.spl[1]=0.013;
	//Hong fixed.strmax[0]=5000.0;
	//Hong fixed.strmax[1]=5000.0;
	fixed.strmax[0]=500.0;
	fixed.strmax[1]=500.0;
	//fixed.pmco2[0]=0.55; // Hong
	//fixed.pmco2[1]=0.55; // Hong
	fixed.pmco2[0]=0.0055; // Hong
	fixed.pmco2[1]=0.0055; // Hong
...
//        frfrac[1] - maximum possible allocation fraction to fine roots
	//Hong fixed.p2co2=0.55;
	//Hong fixed.p3co2=0.55;
	fixed.p2co2=0.0055;
	fixed.p3co2=0.0055;
	fixed.pabres=100.0;
	fixed.pcemic[0]=16.0;
	...
	fixed.rictrl=0.015;
	fixed.riint=0.8;
	//fixed.rsplig=0.3; // Hong
	fixed.rsplig=0.003; // Hong
